#!/bin/sh
# Downloads the MediaPipe runtime and models into macos-app/vendor/.
#
# A packaged app has no CDN to fall back on, and the point of this one is that
# it keeps working with the network off: everything the detector needs is
# fetched once and shipped inside the .app.
#
